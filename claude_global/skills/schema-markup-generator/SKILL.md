...
description: 'Generates schema.org JSON-LD markup for SEO rich snippets. Covers Organization, Product, Article, Breadcrumb, FAQ, Review, Recipe, Event, LocalBusiness. Use when user says: schema markup, schema.org, JSON-LD, rich snippets, rich results, structured data, Google rich cards.'
