...
description: 'Generates a CLAUDE.md file for any repository — analyzes the codebase (tech stack, conventions, architecture, scripts) and produces a ready-to-use CLAUDE.md that teaches Claude Code how to work in that repo. Use when user says: generate CLAUDE.md, init CLAUDE.md, create CLAUDE.md, setup CLAUDE.md, onboard Claude, new repo needs CLAUDE.md.'
