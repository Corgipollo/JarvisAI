...
description: 'Reads current branch diff and writes a complete GitHub pull request description. Creates or updates the PR with one command. Use when user says: write PR description, describe this PR, PR summary, PR body from diff, describe changes, describir PR, descripcion pull request.'
